...
<S.PowpowContainer>
      ...
      <S.ProjectInfo>
        ...
        <S.Description>
          🛍️ Shopping • 📱 SNS • 🏠 My Home • 💳 Payment/Delivery • 👨‍💼 Seller • 🛡️ Admin System
        </S.Description>
        <S.Description>
          <strong>Project Duration:</strong> 2024.10 - 2024.12 (3 months) | <strong>Team Project</strong>
        </S.Description>
        <S.Description>
          <strong>Tech Stack:</strong> React, Node.js, DBeaver(Oracle SQL)
        </S.Description>
        <S.Description>
